...
import com.example.demo.request.DesCompte;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public User desCompte(DesCompte desCompte) {
        User user = userRepository.findUserByUserId(desCompte.getId());
        user.setEmailVerificationStatus(desCompte.getDes());
